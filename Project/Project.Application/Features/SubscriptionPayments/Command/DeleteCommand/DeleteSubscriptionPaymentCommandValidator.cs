...
{
    public class DeleteSubscriptionPaymentCommandValidator : AbstractValidator<DeleteSubscriptionPaymentCommand>
    {
        public DeleteSubscriptionPaymentCommandValidator() 
        {
            RuleFor(p => p.Id)
